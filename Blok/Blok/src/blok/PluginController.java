...
class PluginController implements IPluginController{
    ...
    private ArrayList<String> removePluginFromList;
    ...
    PluginController(ICore core) {
        this.core = core;
        removePluginFromList = new ArrayList<>();
    ...
    @Override
    public ArrayList<String> getClassesNamesInPackage(String url, String packageName) {       
        try{ 
            ArrayList<String> classesFullName = new ArrayList<>();
            ArrayList<String> classesFinal = new ArrayList<>();
