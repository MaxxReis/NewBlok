...
public class Box2D implements ISimulator, Runnable, ContactListener {
    ...
    private ICore core;
    private HashMap<Body, Rectangle> m_bodyRect = new HashMap<>();
    ...
    private Body m_playerBody = null;
    private Rectangle m_player = null;
    ...
    public void bodiesUpdated(ArrayList<Body> bodies) {
        ...
        for (Body body : bodies) {
            Vec2 position = body.getPosition();
            if (body.getUserData() != null)//player
            {
